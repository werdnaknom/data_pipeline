...
class AuxToMainToLoadProfileOnIslandRapids(IFailedAtOncePointBaseCase):
    '''
    This data was created by Anatoliy and failed with the error:
        "None of ['testpoint'] are in the columns".
        Result: FAILURE
    '''
    BASE_DIRECTORY = r"\\npo\coos\LNO_Validation\Improvements\ATS2.0\Andrew's Code\unit_test_data\IFailedAtOnePoint\WestportChannel_Sequencing_TestpointsInColumn"
