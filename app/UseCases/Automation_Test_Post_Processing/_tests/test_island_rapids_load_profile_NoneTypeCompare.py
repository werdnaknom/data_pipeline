...
class AuxToMainToLoadProfileOnIslandRapids(IFailedAtOncePointBaseCase):
    ...
    This data was created by Alex and failed with the error:
        ...
        Result: FAILURE
    '''
    BASE_DIRECTORY = r"\\npo\coos\LNO_Validation\Improvements\ATS2.0\Andrew's Code\unit_test_data\IFailedAtOnePoint\IslandRapids_LoadProfile_NoneTypeCompare"
    AUTOMATION_TEST_DATAFOLDER = "Load Profile"
