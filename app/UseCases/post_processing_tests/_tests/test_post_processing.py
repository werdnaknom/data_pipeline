...
from app.shared.Responses.responses import ResponseSuccess
...
class PostProcessingUseCaseTestCase(BasicTestCase):
    ...
    def _setUp(self):
        ...
        self.uc = PostProcessingWaveFormUseCase(repo=self.mock_repo)
    ...
    def test_find_or_upload_captures(self):
        entities = self.create_fake_datacapture_entities(94)

        self.mock_repo.find_capture_id.return_value = None
        self.mock_repo.insert_one.side_effect = [e._id for e in entities]
        ...
        self.mock_repo.find_capture_id.assert_called()
        self.mock_repo.insert_one.assert_called()
        # self.mock_repo.insert_one.assert_called_with()